                       ...
                       <Container>
                           <Row className="challenge-row" key={challenge.id}>
                               <Col className="col-md-8 challenge-list">
                                   <Link to="/challengeview" onClick={() => handleSave(challenge.id)} className="name">{challenge.name}</Link>
                               ...
                               <Col className="col-md-4 page-btn">
                                   ...
                                   <button className="view-challenge" onClick={() => handleSave(challenge.id)}><Link to="/challengeview">CHALLENGE</Link></button>
                               </Col>
                        </Row>
                     </Container>
