...
const InspirationCheckboxes = (props) => {
  ...
  return (
    ...
    <input type="checkbox" defaultChecked="checked" className="btn-check" name="npm" id="btncheck1" {...props} />
    <label className="btn btn-outline-primary" htmlFor="btncheck1">npm</label>
  
    <input type="checkbox" defaultChecked="checked" className="btn-check" name="api" id="btncheck2" {...props}/>
